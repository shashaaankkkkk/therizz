...
const NavItem = ({ to, label, icon: Icon }) => {
  ...
  return (
    <Link
      to={to}
      className={`flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-lg w-full transition-colors
      ${
        isActive
...
const Sidebar = ({ isOpen }) => (
  <div
    className={`fixed inset-y-0 start-0 z-[60] w-[260px] bg-white
    transform transition-transform duration-300 dark:bg-neutral-800
