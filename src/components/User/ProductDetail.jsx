...
const ProductDetail = () => {
  ...
  const product = {
    ...
    rating: 4.5,
    inStock: true,
    description: 'This classic monochrome t-shirt is made from 100% premium cotton, providing ultimate comfort and durability. Its timeless design makes it suitable for any occasion, whether you\'re dressing up for a casual outing or lounging at home. Available in multiple colors and sizes, this t-shirt is a wardrobe essential for anyone who values style and comfort. Wear it on its own or layer it under a jacket for a trendy look.',
    ...
    <div style={{ display: 'flex', flexDirection: 'column', margin: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <div style={{ flex: 1.3, padding: '0 10px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: 'bold', marginBottom: '5px' }}>{product.name}</h2>
          <h3 style={{ fontSize: '20px', fontWeight: '600', color: '#333', marginBottom: '5px' }}>{product.price}</h3>
          <p style={{ fontSize: '16px', color: '#555', marginBottom: '15px' }}>{product.oneLinerDescription}</p>
      ...
      <div style={{ display: 'flex', justifyContent: 'center', marginTop: '100px', marginBottom: '50px', paddingTop: '10px', paddingLeft: '10px', paddingRight: '10px', marginLeft: '140px', marginRight: '20px' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', width: '100%' }}>
          ...
          <div style={{ flex: 1 }}>
            {showDetails ? (
              <>
                <h4 style={{ fontSize: '20px', fontWeight: 'bold' }}>Description</h4>
                <p style={{ padding: '10px', fontSize: '14px', color: '#555' }}>{product.description}</p>
              </>
            ) : (
              <>
                <h4 style={{ fontSize: '20px', fontWeight: 'bold' }}>Reviews</h4>
